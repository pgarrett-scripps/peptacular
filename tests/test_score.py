...
class TestScore(unittest.TestCase):
    ...
    def test_fragment_match(self):
        ...
        fragments = [
            Fragment(sequence='PEPT', mz=100, charge=1, ion_type='y', number=1, internal=False, parent_number=1),
            Fragment(sequence='PEPT', mz=200, charge=1, ion_type='b', number=1, internal=False, parent_number=1)]
