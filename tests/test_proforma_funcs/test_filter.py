...
class TestFilterMods(unittest.TestCase):
    ...
    def test_filter_mods_keep_static(self):
        annotation = pt.ProFormaAnnotation.parse("<57@C>[Acetyl]-PEPTIDE-[Amide]")
    ...
    def test_filter_mods_keep_isotope(self):
        annotation = pt.ProFormaAnnotation.parse("<15N>[Acetyl]-PEPTIDE-[Amide]")
    ...
    def test_filter_mods_keep_charge(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-PEPTIDE-[Amide]/2")
    ...
    def test_filter_mods_keep_charge_adducts(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-PEPTIDE-[Amide]/2[Na+]")
    ...
    def test_filter_mods_keep_intervals(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-P(EP)[Phospho]TIDE-[Amide]")
    ...
    def test_filter_mods_all_mod_types(self):
        ...
        annotation = pt.ProFormaAnnotation.parse("{Glycan}<57@C>[Unknown]?[Acetyl]-PE[Phospho]PTIDE-[Amide]/2[Na+]")
    ...
    def test_filter_mods_complex_annotation(self):
        annotation = pt.ProFormaAnnotation.parse("{Glycan}<57@C>[Acetyl]-P(EP)[Phospho]TI[Methyl]DE-[Amide]/2")
    ...
    def test_filter_mods_with_intervals_ambiguous(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-P(?EP)TIDE-[Amide]")
        filtered_annotation = annotation.filter_mods(mods=['interval'], inplace=False)
