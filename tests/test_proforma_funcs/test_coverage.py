...
class TestCoverage(unittest.TestCase):
    ...
    def test_coverage_multiple_subsequences(self):
        target = pt.ProFormaAnnotation.parse("PEPTIDE")
        annotations = [pt.ProFormaAnnotation.parse("PEP"), pt.ProFormaAnnotation.parse("TIDE")]
        result = target.coverage(annotations)
    ...
    def test_coverage_overlapping_subsequences(self):
        target = pt.ProFormaAnnotation.parse("PEPTIDE")
        annotations = [pt.ProFormaAnnotation.parse("PEPT"), pt.ProFormaAnnotation.parse("TIDE")]
        result = target.coverage(annotations)
    ...
    def test_coverage_accumulate_true(self):
        target = pt.ProFormaAnnotation.parse("PEPTIDE")
        annotations = [pt.ProFormaAnnotation.parse("PEP"), pt.ProFormaAnnotation.parse("PEP")]  # Same subsequence twice
    ...
    def test_coverage_partial_overlaps(self):
        target = pt.ProFormaAnnotation.parse("PEPTIDE")
        annotations = [pt.ProFormaAnnotation.parse("EPT"), pt.ProFormaAnnotation.parse("TID")]
        result = target.coverage(annotations)
    ...
    def test_coverage_multiple_overlapping_with_accumulate(self):
        target = pt.ProFormaAnnotation.parse("PEPTIDE")
        annotations = [pt.ProFormaAnnotation.parse("PEPT"), pt.ProFormaAnnotation.parse("EPT"), pt.ProFormaAnnotation.parse("PT")]
        result = target.coverage(annotations, accumulate=True)
