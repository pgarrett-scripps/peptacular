...
class TestPopMods(unittest.TestCase):
    ...
    def test_pop_mod_by_type_string(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-PEPTIDE")
        popped_mods = annotation._pop_mod_by_type("nterm")
    ...
    def test_pop_mod_by_type_enum(self):
        annotation = pt.ProFormaAnnotation.parse("[Acetyl]-PEPTIDE")
        popped_mods = annotation._pop_mod_by_type(pt.ModType.NTERM)
    ...
    def test_pop_mod_by_type_invalid(self):
        ...
        with self.assertRaises(TypeError):
            annotation._pop_mod_by_type("invalid_type")  # type: ignore
    ...
    def test_pop_mods_empty_annotation(self):
        ...
        popped_mods = annotation.pop_mods()
        for _, value in popped_mods.items():
    ...
    def test_multiple_pops_return_none(self):
        ...
        self.assertEqual(len(first_pop), 1)  # type: ignore
    ...
    def test_pop_mods_with_multipliers(self):
        ...
        self.assertEqual(len(popped_mods), 1)  # type: ignore
        self.assertIn(1, popped_mods)  # type: ignore
        self.assertEqual(popped_mods[1][0], "Phospho")  # type: ignore
