...
class TestFragment(unittest.TestCase):
    ...
    def test_fragment_multiple_losses_max_2(self):
        ...
        expected = [143.082, 123.082, 128.082, 133.082, 138.082, 72.044, 57.044, 67.044, 62.044]
        self.assertEqual(result, expected)
    ...
    def test_fragment_multiple_losses_label_max_2(self):
        ...
        expected = ['+b2', '+b2(-20)', '+b2(-15)', '+b2(-10)', '+b2(-5)', '+b1', '+b1(-15)', '+b1(-5)', '+b1(-10)']
    ...
    def test_fragment_water_ammonia_loss_label(self):
        ...
        labels = [label for _, label in result]
        expected = ['+b3', '+b3(-18.01056)', '+b3(-17.02655)', '+b2', '+b2(-17.02655)', '+b1']
        self.assertEqual(labels, expected)
