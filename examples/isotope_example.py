...
assert isotopes == [
    (192.05617, 1.0),
    (193.05321, 0.010959894014211729),
    (193.05952, 0.1297887395127868),
]
...
assert isotopes == [
    (799.35997, 1.0),
    (800.36332, 0.3677347619528959),
    (801.36668, 0.06562576793973895),
]
...
isotopes = pt.isotopic_distribution(chemical_formula=composition, max_isotopes=3)
assert isotopes == [
    (1000.0000038305802, 1.0),
    (1001.0033538305802, 0.47589204488021836),
...
isotopes = pt.isotopic_distribution(
    chemical_formula=composition, max_isotopes=3, use_neutron_count=True
)
