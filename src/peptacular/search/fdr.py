...
def calculate_fdr(scores: Sequence[float], target_flags: Sequence[bool], reverse_score: bool = False) -> list[float]:
    """
    ...
    qvalues_with_index = [(orig_idx, qval) for (_, _, orig_idx), qval in zip(indexed_data, qvalues_sorted)]
