...
class FragmentAnnotation:
    ...
    ion_type: Union[
        PeptideIon, # Terminal (use for pt.fragment)
        InternalFragment, # Internal (use for pt.fragment)
        PrecursorIon, # intact (use for pt.fragment)
        ImmoniumIon, # immonium (use for pt.fragment)
        ReferenceIon,
        FormulaIon,
        SMILESIon,
        NamedCompound,
