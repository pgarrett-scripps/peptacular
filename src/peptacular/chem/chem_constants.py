...
# NEUTRAL FRAGMENT COMPOSITIONS
MONOISOTOPIC_FRAGMENT_ADJUSTMENTS: Dict[str, float] = {aa: chem_mass(comp) for aa, comp in NEUTRAL_FRAGMENT_COMPOSITION_ADJUSTMENTS.items()}
AVERAGE_FRAGMENT_ADJUSTMENTS: Dict[str, float] = {aa: chem_mass(comp, monoisotopic=False) for aa, comp in NEUTRAL_FRAGMENT_COMPOSITION_ADJUSTMENTS.items()}

FRAGMENT_ION_ADJUSTMENTS: Dict[str, float] = {aa: chem_mass(comp) for aa, comp in FRAGMENT_ION_COMPOSITIONS.items()}

# FRAGMENT ION COMPOSITIONS (+1)
MONOISOTOPIC_ION_ADJUSTMENTS: Dict[str, float] = {aa: chem_mass(comp) for aa, comp in FRAGMENT_ION_COMPOSITION_ADJUSTMENTS.items()}
AVERAGE_ION_ADJUSTMENTS: Dict[str, float] = {aa: chem_mass(comp, monoisotopic=False) for aa, comp in FRAGMENT_ION_COMPOSITION_ADJUSTMENTS.items()}
